...
{
    public class CodeUniversityDatabaseInitializer :
        //CreateDatabaseIfNotExists<CodeUniversityDbContext>      // when model is stable
        DropCreateDatabaseIfModelChanges<CodeUniversityDbContext> // when iterating
    {
        ...
        protected override void Seed(CodeUniversityDbContext context)
        {
            // Seed code here
        ...
        private List<Room> AddRooms(CodeUniversityDbContext context)
        {
        ...
        private List<TimeSlot> AddTimeSlots(CodeUniversityDbContext context)
        {
        ...
        private List<Track> AddTracks(CodeUniversityDbContext context)
        {
        ...
        private List<Person> AddPersons(CodeUniversityDbContext context, int count)
        {
        ...
        private List<Session> AddSessions(
            CodeUniversityDbContext context,
        ...
        private void AddAttendance(CodeUniversityDbContext context, IEnumerable<Person> attendees)
        {
